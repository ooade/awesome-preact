...
- [Preact Modern Startupper](https://github.com/kolodziejczakM/preact-modern-startupper) - TypeScript, PropTypes, PWA, CSS in JS, Unistore, prerendering, Plop generators, Storybook, Webpack.
